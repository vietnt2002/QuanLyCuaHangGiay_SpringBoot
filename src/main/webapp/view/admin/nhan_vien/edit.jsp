...
<h3 class="text-center mt-5 mb-5">Sửa thông tin nhân viên</h3>
<sf:form method="post" action="/nhan-vien/update/${nhanVien.id}" modelAttribute="nhanVien">
    ...
    <div class="input-group mb-3">
        ...
        <sf:input type="text" class="form-control" name="tenDangNhap" path="tenDangNhap" />
    </div>
    <sf:errors path="tenDangNhap" cssClass="text-danger" />
    <div class="input-group mb-3">
        <span class="input-group-text">Mật khẩu: </span>
        <sf:input type="text" class="form-control" name="matKhau" path="matKhau" />
    </div>
