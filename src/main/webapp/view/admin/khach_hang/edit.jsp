...
<h3 class="text-center mt-5 mb-5">Sửa thông tin khách hàng</h3>
<sf:form method="post" action="/khach-hang/update/${khachHang.id}" modelAttribute="khachHang">
    ...
    <div class="input-group mb-3">
        ...
        <sf:input type="text" class="form-control" name="sdt" path="sdt" />
    </div>
