...
<h3 class="text-center mt-5">Sửa kích thước</h3>
<sf:form method="post" action="/kich-thuoc/update/${kichThuoc.id}" modelAttribute="kichThuoc">
    ...
    <div class="input-group mb-3">
        ...
        <sf:input type="text" class="form-control" name="trangThai" path="trangThai"/>
    </div>
